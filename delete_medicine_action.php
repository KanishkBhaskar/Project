...
<?php
		...
		$sql = "DELETE FROM medicine_database WHERE med_id='$medid'";

			if ($conn->query($sql) === TRUE) {
			echo "<div id='card'><p>Medicine deleted successfully</p><form action='pharmacist_home.php' method='get'><button type='submit' id='done'>ok</button></form></div>";
			} else {
